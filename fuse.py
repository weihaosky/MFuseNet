...
from fuse_utils import train, test, eval
...
if __name__ == '__main__':
    ...
    model = FuseNetwork(args.maxdisp, 2)
    ...
    for epoch in range(epoch_begin+1, args.epochs+1):
        ...
        for batch_idx, (costL_crop, costR_crop, img_crop, disp_crop) in enumerate(TrainImgLoader):
            ...
            loss = train(model, optimizer, [costL_crop, costR_crop], img_crop, disp_crop, args)
        ...
        # ======================== TEST ============================
        if epoch % 10 == 0:
            test_res = test(model, args, epoch)
        ...
        # ======================== EVALUATE ============================
        if epoch % 10 == 0:
            eval_res = eval(model, args, epoch)
            eval_record.append(eval_res)
